package com.yunbiao.yb_smart_meeting.common;
...
//                        .CURRENT_VERSION);
                ...
                map.put("deviceCpu", com.yunbiao.yb_smart_meeting.utils.CommonUtils.getCpuName() + " " + com.yunbiao.yb_smart_meeting.utils.CommonUtils.getNumCores() + "核" + com.yunbiao.yb_smart_meeting.utils.CommonUtils
                        .getMaxCpuFreq() + "khz");
