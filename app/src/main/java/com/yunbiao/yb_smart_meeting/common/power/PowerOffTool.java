package com.yunbiao.yb_smart_meeting.common.power;
...
import com.yunbiao.yb_smart_meeting.common.cache.ACache;
...
public class PowerOffTool {
    ...
    private void executefailedPowerDown() {
        ...
        if (!TextUtils.isEmpty(poweroff)) {
            ...
            String currentTime = com.yunbiao.yb_smart_meeting.utils.CommonUtils.getStringDate();
...
//        OnOffTool.setEnabled((byte) 0, (byte) 1, (byte) 0, (byte) 1);
    ...
    public void powerShutdown() {
        if (com.yunbiao.yb_smart_meeting.utils.CommonUtils.boardIsXBH()) {
        } else if (com.yunbiao.yb_smart_meeting.utils.CommonUtils.boardIsJYD()) {
        } else {
            Process process = null;
            try {
                process = Runtime.getRuntime().exec("su");
