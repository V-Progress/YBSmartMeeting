package com.yunbiao.yb_smart_meeting.bean;
...
public class AdvertBean {
    ...
    public class AdvertObjectEntity {
        ...
        private List<Entity> imgArray;
        private int advertId;
        private List<Entity> videoArray;

        public List<Entity> getVideoArray() {
            return videoArray;
        }

        public void setVideoArray(List<Entity> videoArray) {
        ...
        public void setImgArray(List<Entity> imgArray) {
        ...
        public List<Entity> getImgArray() {
            return imgArray;
        }
